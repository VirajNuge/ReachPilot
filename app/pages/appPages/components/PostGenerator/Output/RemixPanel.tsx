      ...
      {styles.map((style) => {
        ...
        return (
          <motion.button
            ...
            disabled={isRemixing}
            className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-blue-200 hover:text-[#0052FF] transition-all duration-200 font-bold text-xs text-gray-600 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <span>{emoji}</span>
            <span>{label}</span>
