    ...
    <div className="min-h-screen bg-gradient-to-br from-[#EEF2F8] via-[#F5F7FA] to-[#E8EDF3]">
      {view !== "output" ? (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          {isHistoryOpen && (
            <div className="max-w-2xl mx-auto mb-5 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b border-[#E2E8F0] bg-[#F8FAFD] flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#64748B] hover:text-[#0052FF]"
                >
                  Refresh
                </button>
              </div>
