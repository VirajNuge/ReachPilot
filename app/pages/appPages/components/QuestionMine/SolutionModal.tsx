        ...
        <div className="flex-1 flex flex-col bg-white relative">
          ...
          <div className="p-6 border-t border-gray-100 bg-white flex justify-end gap-3 z-20">
            <button
              ...
              className="px-5 py-3 rounded-xl font-bold hover: transition-all flex items-center gap-2 bg-[#000100] hover:bg-black text-white"
            >
            ...
            <button className="px-6 py-3 rounded-xl font-bold transition-all flex items-center gap-2 bg-[#000100] hover:bg-black text-white">
