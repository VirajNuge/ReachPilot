...
export default function CopyCatEngine() {
  return (
    // ⭐ STYLE UPDATE: Changed to White Background + Gray Borders to match app theme
    <div className="w-full bg-white border border-gray-200 rounded-2xl p-6 shadow-sm mt-8 mb-8">
      {/* Header Section */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="p-1.5 bg-yellow-50 border border-yellow-100 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {TOP_POSTS_DATA.map((post) => (
          <div
            key={post.id}
            className="bg-gray-50/50 border border-gray-200 rounded-xl p-5 hover:bg-white hover:border-indigo-300 hover:shadow-md transition-all group flex flex-col"
          >
            {/* Card Header: Format & Score */}
            <div className="flex justify-between items-start mb-4">
              <span className="px-2 py-1 bg-white border border-gray-200 rounded-md text-[10px] font-bold uppercase tracking-wide text-gray-500">
                {post.format}
              </span>
            ...
            <div className="mb-6 flex-1">
              <h4 className="font-bold text-gray-900 text-lg leading-tight mb-3 group-hover:text-indigo-600 transition-colors">
                "{post.headline}"
              </h4>
            ...
            <div className="mt-auto">
              <div className="flex items-center gap-4 text-xs font-medium text-gray-400 mb-4 border-t border-gray-100 pt-3">
